 ...
 return res.send(e);
  ...
  router.get('/Public_Search_Student_Details/',function(req,res,next)
  { 
  try 
  {
  Public_Data.Public_Search_Student_Details(req.query, function (err, rows) 
  {
  if (err) 
  {    
  res.json(err); 
...
try 
{
  ...
  Public_Data.Public_Search_Job(req.query.Job_Title_,req.query.Qualification_,req.query.Experience_,req.query.Functional_Area_,req.query.Specialization_,req.query.Page_Start_,req.query.Page_End_,req.query.Page_Length_,function (err, rows) 
{
if (err) 
{
res.json(err);
...
router.get('/Load_Candidate_Dropdowns/',function(req,res,next)
  ...
  try 
  {
    Public_Data.Save_Agent(req.body, function (err, rows) 
  {
  if (err) 
  {
  ...
  router.post('/Save_Student_Public/',function(req,res,next)
  { 
  try 
  {
    Public_Data.Save_Student_Public(req.body, function (err, rows) 
  {
  if (err) 
  {
